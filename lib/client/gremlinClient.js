...
let gremlinClient = class gremlinClient {
    constructor(config) {
        ...
        this._convertService =
            this._glue.container.get(contracts.tContracts.IConvertService);
        if (config) {
    ...
    convertObjectToGremlinEdges(obj, edgeLabel) {
        return this._convertService.convertObjectToGremlinEdges(obj, edgeLabel);
    }
    convertObjectToGremlinVertices(obj, vertexLabel) {
        return this._convertService.convertObjectToGremlinVertices(obj, vertexLabel);
    }
    ...
    executeFileAsync(file, options) {
        return __awaiter(this, void 0, void 0, function* () {
            var result = yield this._gremlinService.executeFileAsync(file, options);
            return result;
        });
    }
    executeLinesAsync(lines, options) {
        return __awaiter(this, void 0, void 0, function* () {
            var result = yield this._gremlinService.executeLinesAsync(lines, options);
            return result;
        });
    }
    executeAsync(query, options) {
        return __awaiter(this, void 0, void 0, function* () {
            var result = yield this._gremlinService.executeAsync(query, options);
            return result;
        });
    }
    init() {
